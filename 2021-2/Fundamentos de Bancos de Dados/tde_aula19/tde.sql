...
INSERT INTO clientes (nome,endereco,telefone,cpf,cidade)
    ...
    INSERT INTO alugueis (data_aluguel,data_devolu,valor_double,id_cliente,id_carro)
	VALUES ('2019-08-17','2019-02-06','1601.00',71,231),
    ('2019-02-07','2019-06-26','232.00',1,96),
    ('2018-06-09','2019-10-07','115.00',192,849),
    ('2018-07-12','2019-07-06','801.00',190,677),
    ('2019-04-05','2019-03-01','406.00',951,230),
    ('2019-06-27','2018-03-29','1120.00',231,339),
    ('2019-11-27','2018-09-03','546.00',380,503),
    ('2018-02-28','2019-12-04','176.00',87,93),
    ('2019-03-07','2018-04-01','1493.00',828,836),
    ('2018-07-20','2018-06-02','706.00',887,888),
    ('2018-05-29','2018-02-03','1843.00',624,434),
    ('2019-06-19','2019-02-14','1437.00',645,797),
    ('2019-10-17','2018-07-26','447.00',663,96),
    ('2018-11-18','2018-11-10','1414.00',493,464),
    ('2018-08-02','2019-12-30','137.00',197,521),
    ('2019-02-11','2019-03-01','294.00',211,237),
    ('2019-07-22','2019-08-12','1380.00',896,393),
    ('2018-11-29','2018-07-04','915.00',669,685),
    ('2019-07-26','2019-05-02','717.00',572,21),
    ('2019-12-25','2018-05-07','970.00',417,239),
    ('2019-08-13','2018-06-10','942.00',55,96),
    ('2019-07-26','2018-01-05','1406.00',342,340),
    ('2019-08-10','2019-10-16','1150.00',810,119),
    ('2019-03-02','2019-07-19','390.00',132,336),
    ('2018-12-15','2019-07-20','91.00',190,84),
    ('2019-09-22','2018-06-25','1750.00',537,399),
    ('2019-06-16','2019-08-06','1443.00',909,711),
    ('2018-10-25','2019-10-04','598.00',912,236),
    ('2019-06-07','2018-02-18','1470.00',272,310),
    ('2018-09-21','2019-10-05','1558.00',975,956),
    ('2018-08-30','2019-06-10','528.00',220,558);


-- maior valor de aluguel, mostrando qual o modelo do veículo e o nome do cliente que alugou.
...
-- quantos alugueis no ano de 2020 por cliente e quem tem mais alugueis? e quais os 5 primeiros que tem mais alugueis?
SELECT		COUNT(a.registro) as quantidade_alugueis, cl.nome
FROM		alugueis a
				inner join clientes cl
                	on a.id_cliente = cl.id
where		data_aluguel between "2021-01-01" and "2021-12-31"
GROUP BY	cl.nome
